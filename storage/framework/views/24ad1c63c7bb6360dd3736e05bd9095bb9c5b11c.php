...
<body>
        ...
        <div class="row">
          <div class="col-md-12 mb-2">
            <div class="form-group">
              <label for="Type">Search Properties</label>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="/">
        ...
        <img src="<?php echo e(asset('images/logo.png')); ?>" style="width: 140px;heigth:60px;" alt="logo">
      </a>
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo e(request()->is('contact-us') ? 'active' : ''); ?>" href="<?php echo e(route('contact')); ?>">Contact</a>
          </li> 
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <?php if(auth()->user()->is_admin == 1): ?>
                  <a href="<?php echo e(route('admin.index')); ?>" class="dropdown-item">Dashboard</a> 
                <?php else: ?>
                    <a class="dropdown-item" href="<?php echo e(route('property.index')); ?>">My Dashboard</a>
                    <a href="<?php echo e(route('property.create')); ?>" class="dropdown-item">POST</a> 
                <?php endif; ?>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">Epil Developer</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <a href="/">Kingwisdom</a>
  ...
  <script src="<?php echo e(asset('assets/lib/popper/popper.min.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('assets/lib/scrollreveal/scrollreveal.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\EstateAgentPHP\resources\views/layouts/temp.blade.php ENDPATH**/ ?>