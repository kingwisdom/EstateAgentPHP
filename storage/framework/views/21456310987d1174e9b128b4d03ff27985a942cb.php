          ...
          <?php $__currentLoopData = $props; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="<?php echo e(asset('images/'.$prop->featureImg)); ?>" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="#"><?php echo e($prop->title); ?></a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a"><?php echo e($prop->type); ?> | <?php echo e($prop->price); ?></span>
                      </div>
                      <a href="<?php echo e(route('property.show',$prop->id)); ?>" class="link-a">Click here to view
      ...
      <div id="new-carousel" class="owl-carousel owl-theme">
        <div class="carousel-item-c">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="<?php echo e(asset('assets/img/post-2.jpg')); ?>" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
        ...
        <div class="carousel-item-c">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="<?php echo e(asset('assets/img/post-5.jpg')); ?>" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-category-b">
        ...
        <div class="carousel-item-c">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="<?php echo e(asset('assets/img/post-7.jpg')); ?>" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-category-b">
        ...
        <div class="carousel-item-c">
          <div class="card-box-b card-shadow news-box">
            <div class="img-box-b">
              <img src="<?php echo e(asset('assets/img/post-3.jpg')); ?>" alt="" class="img-b img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-header-b">
                <div class="card-category-b">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-img">
                  <img src="<?php echo e(asset('assets/img/testimonial-1.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonial-author-box">
                  <img src="<?php echo e(asset('assets/img/mini-testimonial-1.jpg')); ?>" alt="" class="testimonial-avatar">
        ...
        <div class="carousel-item-a">
          <div class="testimonials-box">
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-img">
                  <img src="<?php echo e(asset('assets/img/testimonial-2.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-ico">
                ...
                <div class="testimonial-author-box">
                  <img src="<?php echo e(asset('assets/img/mini-testimonial-2.jpg')); ?>" alt="" class="testimonial-avatar">
...
<?php echo $__env->make('layouts.temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\EstateAgentPHP\resources\views/pages/index.blade.php ENDPATH**/ ?>